                ...
                <div class="bs-stepper-content">
                    <form id="wizard-create-deal-form" onsubmit="return false">
                        ...
                        <div id="deal-type"
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/illustrations/shopping-girl-light.png"
                                ...
                                <div class="col-sm-6 fv-plugins-icon-container">
                                    ...
                                    <div id="dealAmountHelp" class="form-text">Enter the discount percentage. 10 = 10%
                                    </div>
                                    <div
                                ...
                                <div class="col-sm-6 fv-plugins-icon-container">
                                    ...
                                    <div class="position-relative"><select id="dealRegion" name="dealRegion"
                                            class="select2 form-select select2-hidden-accessible" multiple=""
                                            aria-describedby="dealRegionHelp" data-select2-id="dealRegion" tabindex="-1"
                                            aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="1" style="width: 388px;"><span
                                                class="selection"><span
                                                    ...
                                                    <ul class="select2-selection__rendered">
                                                        <li class="select2-search select2-search--inline"><input
                                                                ...
                                                                aria-autocomplete="list" placeholder="Select an region"
                                                                style="width: 374px;"></li>
                                                    </ul>
                                                </span></span><span class="dropdown-wrapper"
                                                aria-hidden="true"></span></span></div>
                                    <div id="dealRegionHelp" class="form-text">Select applicable regions for the deal.
                                    </div>
                                    <div
                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-0 py-1"><span class="fw-medium">2021-07-14</span> to
                                                            <span class="fw-medium">2021-07-30</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>

...
<div class="nav-align-top mb-4">
  ...
  <ul class="nav nav-tabs nav-fill" role="tablist">
    <li class="nav-item" role="presentation">
      <a type="button" class="nav-link {{ (int) $status === 0? 'active': '' }}" href="?status=pending"  aria-controls="awaitingFlaggedUsersTab" aria-selected="true">Level 1</a>
      <div class="{{  (int) $status === 0 ? 'tab--selected': '' }} tab__slider"></div>
    </li>
    <li class="nav-item" role="presentation">
      <a type="button" class="nav-link {{ (int) $status === 1? 'active': '' }}" href="?status=resolved"  aria-controls="solovedFlaggedUsersTab" aria-selected="false" tabindex="-1">Level 2</a>

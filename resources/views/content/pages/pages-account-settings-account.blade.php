...
<div class="row">
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      ...
      <li class="nav-item"><a class="nav-link" href="javscript:void(0)"><i class="bx bx-lock-alt me-1"></i>Security</a></li>
      <li class="nav-item"><a class="nav-link" href="javscript:void(0)"><i class="bx bx-detail me-1"></i>Billing & Plans</a></li>
      <li class="nav-item"><a class="nav-link" href="javscript:void(0)"><i class="bx bx-bell me-1"></i>Notifications</a></li>
      <li class="nav-item"><a class="nav-link" href="javscript:void(0)"><i class="bx bx-link-alt me-1"></i>Connections</a></li>
    </ul>
    <!--/ User Pills -->
